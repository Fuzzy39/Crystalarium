...
namespace Crystalarium.Main
{
    public class CrystalGame : Game
    {
        ...
        private const int BUILD = 660; // I like to increment this number every time I run the code after changing it. I don't always though.
        ...
        protected override void LoadContent()
        {
            ...
            Textures.sampleAgent = Content.Load<Texture2D>("emitter");
